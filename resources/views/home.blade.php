                                            ...
                                            <div class="col-lg-4">
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0 me-3">
                                                        <img src="<?php echo url('assets')?>/images/users/avatar-1.jpg" alt="" class="avatar-md rounded-circle img-thumbnail">
                                                    </div>
                                    ...
                                    <div>
                                        <div class="row">
                                            ...
                                            <div class="col-5 align-self-end">
                                                <img src="<?php echo url('assets')?>/images/profile-img.png" alt="" class="img-fluid">
                                            </div>
                                        </div>
                                    </div>
                                </div>
