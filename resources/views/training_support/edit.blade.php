@extends('layouts.app')
@section('title', 'Edit Training Support')
...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Edit Training Support</h4>
            ...
            <form method="POST" action="{{ route('training_support.update', $trainingSupport->id) }}">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="col-md-10">
                                        <select name="franchise_id" class="form-control" required>
                                            ...
                                            @foreach($franchises as $franchise)
                                                <option value="{{ $franchise->franchise_id }}" {{ $franchise->franchise_id == $trainingSupport->franchise_id ? 'selected' : '' }}>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="training_support" class="form-control rich-editor" rows="4">{!! $trainingSupport->training_support !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="technology_tools" class="form-control rich-editor" rows="4">{!! $trainingSupport->technology_tools !!}</textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <select name="{{ $field }}" class="form-control">
                                                <option value="0" {{ !$trainingSupport->$field ? 'selected' : '' }}>No</option>
                                                <option value="1" {{ $trainingSupport->$field ? 'selected' : '' }}>Yes</option>
                                            </select>
                                        </div>
                                    </div>
                                @endforeach
