@extends('layouts.app')
@section('title', 'Create Franchisee Profile')
...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Create Franchisee Profile</h4>
            ...
            <form method="POST" action="{{ route('franchisee_profiles.store') }}">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="ideal_candidate_traits" class="form-control rich-editor"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="training_support_description" class="form-control rich-editor"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="available_states" class="form-control rich-editor"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="store_opening_support_description" class="form-control rich-editor"></textarea>
                                    </div>
                                </div>
