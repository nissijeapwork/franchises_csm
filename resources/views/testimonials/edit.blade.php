...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form method="POST" action="{{ route('testimonials.update', $testimonial->testimonial_id) }}">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="col-md-10">
                                        <select name="franchise_id" class="form-control" required>
                                            ...
                                            @foreach($franchises as $franchise)
                                                <option value="{{ $franchise->franchise_id }}" {{ $testimonial->franchise_id == $franchise->franchise_id ? 'selected' : '' }}>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="location" class="form-control" value="{{ old('location', $testimonial->location) }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="quote" class="form-control rich-editor" rows="5">{{ old('quote', $testimonial->quote) }}</textarea>
                                    </div>
                                </div>
