      ...
      <div class="row">
        <div class="col-12">
          <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Create Operation</h4>
              ...
              <div class="card-body">
                ...
                @foreach ([
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                      <textarea name="{{ $field }}" class="form-control rich-editor" rows="3"></textarea>
                    </div>
                  </div>
                @endforeach
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-md-10">
                    <input type="text" name="number_type_employees" class="form-control">
                  </div>
                </div>
