@extends('layouts.app')
@section('title', 'Create Performance Metrics')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Create Performance Metrics</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="number" name="new_units_opened_last_year" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="number" step="0.01" name="growth_score" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="number" step="0.01" name="turnover_score" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="unit_trend_chart_data" rows="4" class="form-control"></textarea>
                                    </div>
                                </div>
